...
const planetData = {
  ...
  Playlist: {
    title: "Playlist",
    summary: "제 노동요는요...",
    description: "서정적인 발라드와 팝송이에요! 배경음악이 숨어있을지도..?",
    image: "",
  },
  Hobby: {
    title: "Hobby",
    ...
    description:
      "저는 칵테일을 만들어서 마시는 걸 좋아하구요! 백준을 꾸준히 풀려고 노력 중이에요!",
    image: "",
  },
};
const subData = {
  Goal: {
    title: "Goal",
    description:
      "풀스택을 통해 웹 개발 전반에 대한 이해도를 높이고 싶어요. 그리고 멋사의 부원들과 함께 프로젝트는 물론 다양한 활동들을 통해 자연스럽게 친해지고, 별처럼 빛나는 분들과 가까워지고 싶어요. 또한 여러 해커톤과 아이디어톤에도 도전하여, 수상에 가까이 다가가 보는 경험을 해보고자 합니다!! 궁극적으로는 이러한 세션을 모두 완수하고나서 정말 멋쟁이사자가 되어서, 다른 도움이 필요한 학우들이 있으면 언제든지 당당하게 도와드릴 수 있는 제가 있길 바라요 :)",
    image: "",
  },
  Intro: {
    title: "Intro",
