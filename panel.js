...
const bottomPlanet = document.querySelector(".planet--bottom");

document.querySelectorAll(".planet").forEach((planet) => {
  planet.addEventListener("click", (e) => {
    if (planet.classList.contains("planet--bottom")) {
      let pos = planet.id;
...
const otherPlanets = document.querySelectorAll(".planet:not(.planet--bottom");
